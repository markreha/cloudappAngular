...
export class WeatherComponent implements OnInit 
{
  ...
  public async onSubmit()
  {
    ...
    let url = "https://mark-servicesapp.herokuapp.com/rest/weather/get/" + deviceId + "/" + fromDate + "/" + toDate;
    const res = await this.axiosInstance.get(url, { auth: {username: 'CHANGEME', password: 'CHANGEME' }});
    if(res.status !== 200)
    {
